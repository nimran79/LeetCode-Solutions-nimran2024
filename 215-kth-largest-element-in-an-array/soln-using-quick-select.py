class Solution:
    def findKthLargest(self, nums: List[int], k: int) -> int:
        ...
        def quick_select(start, end, k_smallest):
            ...
            # the pivot are to the left and all elements less than are to the right
            while left < right:
            ...
            # If the partitioning index is less than k_smallest, we know that the kth largest element must be in the right partition.
            # If it's greater than or equal to k_smallest, the element will be in the left partition.
            if right < k_smallest:
